...
// 1. Initialize (required in every screen)
ResponsiveHelper.init(context);
...
Column(
  children: [
    Widget1(),
    16.verticalSpace,   // Vertical spacing
    Widget2(),
  ],
)
...
Row(
  children: [
    Widget1(),
    12.horizontalSpace, // Horizontal spacing
    Widget2(),
  ],
)
...
Container(
  ...
  padding: 20.paddingVertical,   // Top/bottom only
  padding: 24.paddingHorizontal, // Left/right only
  child: Text('Padded content'),
)

// 5. Device-specific values
double fontSize = context.responsive<double>(
  mobile: 14.0,
  tablet: 18.0,
  desktop: 22.0,
  fallback: 16.0,
...
// 7. Smart defaults
EdgeInsets padding = context.dynamicPadding.padding;
double textScale = context.dynamicTextScale;
